...
const MyLogoCard: React.FC<MyLogoCardProps> = ({
  item,
  onRemove,
  onEdit,
  page,
  ...
  useEffect(() => {
    // Make sure toast is ready after the component is mounted
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-indigo-800/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          {/* <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
            <h3 className="text-lg font-normal">{item.prompt}</h3>
          </div> */}
        </div>
        <motion.div
